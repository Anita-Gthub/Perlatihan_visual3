...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame.setGeometry(QtCore.QRect(10, 10, 931, 521))
        self.frame.setMinimumSize(QtCore.QSize(0, 0))
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.frame_2 = QtWidgets.QFrame(self.frame)
        self.frame_2.setGeometry(QtCore.QRect(10, 10, 200, 500))
        self.frame_2.setMinimumSize(QtCore.QSize(200, 500))
        self.frame_2.setMaximumSize(QtCore.QSize(200, 16777215))
        self.frame_2.setStyleSheet("background-color: rgb(187, 226, 255);\n"
...
"background-color: rgb(196, 223, 230);")
        ...
        self.frame_3.setGeometry(QtCore.QRect(220, 10, 700, 500))
        self.frame_3.setMinimumSize(QtCore.QSize(700, 500))
        self.frame_3.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.frame_3.setStyleSheet("background-color: rgb(196, 223, 230);")
        ...
        self.frame_4.setStyleSheet("background-color: rgb(0, 59, 70);")
        ...
        self.pushButton.setStyleSheet("background-color: rgb(102, 165, 173);")
        self.pushButton.setObjectName("pushButton")
        self.horizontalLayout_2.addWidget(self.pushButton)
        self.pushButton_2 = QtWidgets.QPushButton(self.frame_4)
        self.pushButton_2.setStyleSheet("background-color: rgb(102, 165, 173);")
        self.pushButton_2.setObjectName("pushButton_2")
        self.horizontalLayout_2.addWidget(self.pushButton_2)
        self.pushButton_3 = QtWidgets.QPushButton(self.frame_4)
        self.pushButton_3.setStyleSheet("background-color: rgb(102, 165, 173);")
        self.pushButton_3.setObjectName("pushButton_3")
        self.horizontalLayout_2.addWidget(self.pushButton_3)
        self.pushButton_4 = QtWidgets.QPushButton(self.frame_4)
        self.pushButton_4.setStyleSheet("background-color: rgb(102, 165, 173);")
        self.pushButton_4.setObjectName("pushButton_4")
        self.horizontalLayout_2.addWidget(self.pushButton_4)
        self.verticalLayout.addWidget(self.frame_4)
        self.frame_5 = QtWidgets.QFrame(self.frame_3)
        self.frame_5.setStyleSheet("background-color: rgb(7, 87, 91);")
